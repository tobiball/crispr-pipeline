...
use crate::prediction_tools::chopchop_integration::{parse_chopchop_results, run_chopchop, ChopchopOptions};
...
pub fn get_df () -> Result<ValidationData, PolarsError> {
...
pub struct AvanaDataset {
    efficacy_path: String,
    guide_map_path: String,
}
